...
public class OmsOrderReturnApplyController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("ware:omsorderreturnapply:list")
    ...
    //@RequiresPermissions("ware:omsorderreturnapply:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("ware:omsorderreturnapply:save")
    ...
    //@RequiresPermissions("ware:omsorderreturnapply:update")
    ...
    //@RequiresPermissions("ware:omsorderreturnapply:delete")
