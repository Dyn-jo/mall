...
import com.dyn.mall.ware.service.OmsOrderService;
...
public class OmsOrderController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("ware:omsorder:list")
    ...
    //@RequiresPermissions("ware:omsorder:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("ware:omsorder:save")
    ...
    //@RequiresPermissions("ware:omsorder:update")
    ...
    //@RequiresPermissions("ware:omsorder:delete")
